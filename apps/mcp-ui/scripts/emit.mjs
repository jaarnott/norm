...
const SOURCES = [
  ...
  'apps/web/app/components/display/Combobox.tsx',
  'apps/web/app/components/display/recipeCost.ts',
  'apps/web/app/components/display/HtmlField.tsx',
  'apps/web/app/lib/pageDocument.ts',
